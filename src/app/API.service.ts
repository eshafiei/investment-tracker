...
export class APIService {
  ...
  OnCreatePrivateNoteListener(
    owner: string
  ): Observable<SubscriptionResponse<OnCreatePrivateNoteSubscription>> {
  ...
  OnUpdatePrivateNoteListener(
    owner: string
  ): Observable<SubscriptionResponse<OnUpdatePrivateNoteSubscription>> {
  ...
  OnDeletePrivateNoteListener(
    owner: string
  ): Observable<SubscriptionResponse<OnDeletePrivateNoteSubscription>> {
